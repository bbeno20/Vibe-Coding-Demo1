...
_Observed behaviour: reach 1; core action 0; stall point Invite one teammate; explained away NA; own first run Had to think a few times, like where to start and what the button label meant._
